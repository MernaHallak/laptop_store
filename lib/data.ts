import type { Product, Shop, ShopCategory, ShopCategoryCard } from './types';
...
export const products: Product[] = [
  ...
  p(3, {
    ...
    descriptionKey: "asusRogStrixG16",
  }),
  p(3, {
    name: "MSI Katana 15",
    brand: "MSI",
  ...
  p(4, {
    ...
    descriptionKey: "hpEliteBook840Refurb",
  }),
  p(4, {
    ...
    descriptionKey: "thinkPadT480Refurb",
  }),
  ...
  p(5, {
    ...
    descriptionKey: "surfaceLaptopGo",
  }),
  p(5, {
    name: "Chromebook 14",
    brand: "HP",
  ...
  p(6, {
    ...
    descriptionKey: "asusZenbookOled14",
  }),
  ...
  p(7, {
    ...
    descriptionKey: "dellLatitude7440",
  }),
  p(7, {
    name: "HP ProBook 450",
    brand: "HP",
  ...
  p(8, {
    ...
    descriptionKey: "usedMacbookPro13",
  }),
  p(8, {
    ...
    descriptionKey: "usedLenovoLegion5",
  }),
